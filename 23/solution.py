            ...
            if lists[i] != None:
                if lists[i].val != None:
                    if lists[i].val not in header_vals:
                        ...
                        header_vals[ lists[i].val ].append( i )

        return self.merge( lists, header_vals )

    def merge( self, lists, header_vals ):
